...
session = boto3.Session(
  aws_access_key_id='f41b0694-ee66-443b-8323-18f56a30c650',
  aws_secret_access_key='IGueCTadMWgZNLZf3pYxx52XD0sl0XgL',
)
...
object_key = 'us_stocks_sip/trades_v1/2025/03/2025-07-14.csv.gz'
